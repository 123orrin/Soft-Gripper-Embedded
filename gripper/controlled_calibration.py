...
while joystick_clicked_times < 3:
    ...
    if count < desired:
        while count < desired and time_in_loop < loop_timeout:
            ...
            elif joystick_clicked_times == 1:
                kit.motor2.throttle = 0.30
                motor1_encoderA_val = GPIO.input(MOTOR2_ENCODER_PIN_A)
                motor1_encoderB_val = GPIO.input(MOTOR2_ENCODER_PIN_B) 
            elif joystick_clicked_times == 2:
                kit.motor3.throttle = 0.30
                motor1_encoderA_val = GPIO.input(MOTOR3_ENCODER_PIN_A)
                motor1_encoderB_val = GPIO.input(MOTOR3_ENCODER_PIN_B) 
